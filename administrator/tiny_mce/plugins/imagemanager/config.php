<?php
	...
	// Preview options
	$mcImageManagerConfig['preview.wwwroot'] = '../../../../upload/'; // absolute or relative from this script path, try to leave blank system figures it out.
	$mcImageManagerConfig['preview.urlprefix'] = "//{host}/congty/huynhki/upload/"; // domain name
