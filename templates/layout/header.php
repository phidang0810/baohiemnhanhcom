...
<div id="header" style=" no-repeat top left">
        
        <div id="banner" style="position:relative;height:118px">
            <p style="margin-bottom:10px ; align:center "><embed height="119" width="960" type="application/x-shockwave-flash" allowscriptaccess="always" wmode="transparent" allowfullscreen="false" scale="noborder" pluginspage="http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash" quality="high" src="images/MIC.swf" title=" "/></p>
