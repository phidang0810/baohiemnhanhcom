...
<div style="font-weight:bold;z-index:999;height:30px;line-height:30px;background:#069;color:#ffffff;width:150px;position:fixed;bottom:0;right:0;padding-left:20px">Hotline : <?php echo $hotline['didong'] ?></div>