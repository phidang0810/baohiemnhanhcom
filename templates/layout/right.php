<?php
$d->reset();
$sql="select * from table_news where hienthi=1 and id_item=1 order by stt limit 0,9";
$d->query($sql);
...
<div class="modul" style="border:none">
    ...
    <div class="content" style="border:1px solid #CCC;padding-bottom:10px">
    	<div style="background:url(images/phone-icon.png) no-repeat 10px 0;padding-left:70px">
            ...
            <br/><span style="color:#069;font-size:15px;font-weight:bold"><?=$result_hl['dienthoai']?></span>
        <br/><br/>
